...
class cr_4:
    ...
    def run(self)->str:
        ...
        self.driver.find_element_by_xpath('//*[@id="menu_sales"]').click()
        # driver.find_element_by_xpath('//*[@id="sub_tree"]')
        # //*[@id="menu_sales"]
        # /html/body/table/tbody/tr[1]/td/table/tbody/tr[2]/td/table/tbody/tr/td[4]/div/a[3]
        time.sleep(3)
        # 구매발주등록
        self.driver.find_element_by_xpath('/html/body/table/tbody/tr[2]/td/div[2]/div[1]/div[2]/ul/li[2]/ul/li[9]').click()
        #  /html/body/table/tbody/tr[2]/td/div[2]/div[1]/div[2]/ul/li[2]/ul/li[9]
        self.driver.switch_to.frame('iwsm4070')
        # iwsm4070



        time.sleep(1)
        selected_start_date = self.driver.find_element_by_id('start_date')
        selected_end_date = self.driver.find_element_by_id('end_date')
        ...
        for k in range(0, int(days)):
            ...
            # //*[@id="btnExcel"]
            # /html/body/div[2]/form/table/tbody/tr/td[2]/button[2]
            self.driver.implicitly_wait(20)
