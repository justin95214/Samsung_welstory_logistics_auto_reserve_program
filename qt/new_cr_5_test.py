...
class cr_5:
    ...
    def run(self)->str:
        ...
        time.sleep(3)
        # 구매발주등록
        self.driver.find_element_by_xpath('/html/body/table/tbody/tr[2]/td/div[2]/div[1]/div[2]/ul/li[2]/ul/li[11]').click()
        #  /html/body/table/tbody/tr[2]/td/div[2]/div[1]/div[2]/ul/li[2]/ul/li[9]
        self.driver.switch_to.frame('iwsm4060')
        # iwsm4070
